...
flight <- flight[seq(1, nrow(flight), by = 60), ]
```
...
plot(Filter(is.numeric,flight)[ ,-1], pch=150,col="blue",cex=25)
```
...
plot <- ggpairs(flight[ ,c("TotChol",CharVar)], lower='blank',upper=list(continuous = wrap('points', color = 'blue'),combo = wrap('box', fill = 'blue', outlier.color = 'blue')), diag=list(continuous=wrap('barDiag',fill = 'blue')), progress = FALSE,axisLabels="none")
```
