...
Siin veeru nimi vahetada!
Teine varjand: flights <- subset(flights, select = -c(AIR_SYSTEM_DELAY, SECURITY_DELAY, LATE_AIRCRAFT_DELAY, WEATHER_DELAY))

```{r}
flight <- na.omit(flight[, -which(flight)=="veeru nimi"])
```
...
plot(plot_data, 
     ...
     col = "skyblue", 
     cex = 0.5,      # Smaller points to avoid overplotting
